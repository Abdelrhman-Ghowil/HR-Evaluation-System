...
const uiLabels = {
  ...
  ar: {
    title: 'قاموس الجدارات',
    subtitle: 'دليل مرجعي للجدارات الأساسية والقيادية.',
    coreCompetencies: 'الجدارات الأساسية',
    leadershipCompetencies: 'الجدارات القيادية',
    functionalCompetencies: 'الجدارات الوظيفية',
    total: 'الإجمالي',
    allCompetencies: 'جميع الجدارات',
    core: 'أساسية',
    leadership: 'قيادية',
    searchPlaceholder: 'البحث في الجدارات...',
    showing: 'عرض',
    competencies: 'جدارات',
    definition: 'التعريف',
    ...
    competenciesStructure: 'هيكل الجدارات',
    structureDescription: 'يشمل هيكل الجدارات في نينجا أنواع الجدارات، ومستويات الإتقان، ودرجة التفصيل لكل جدارة. يوضّح الشكل أدناه الأنواع المختلفة من الجدارات التي تم تحديدها في نينجا:',
    corePoints: [
